...
export function MuscleComparisonCard({ item }: MuscleComparisonCardProps) {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow border border-gray-200 flex items-start space-x-4">
      <div
        className={`w-10 h-10 rounded-full flex items-center justify-center ${iconBgClass} flex-shrink-0 mt-1`}
      >
        {arrowIcon}
      </div>
      <div className="flex-grow">
        <h4 className="font-semibold text-gray-800 text-md capitalize">
