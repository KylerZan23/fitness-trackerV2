...
export function ExerciseSelector({ selectedMuscleGroup, onSelectExercise }: ExerciseSelectorProps) {
  ...
  const filteredExercises = searchQuery
    ? exercises.filter(exercise => exercise.name.toLowerCase().includes(searchQuery.toLowerCase()))
    : exercises
