          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 my-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-white/70 mb-6">
                You haven't logged any workouts during this period. Log some workouts to see your muscle heatmap!
              </p>
        ...
        <div className="mt-8 border-t border-white/10 pt-4">
          <details className="group">
            ...
            <div className="pt-2 pb-4 text-white/70 space-y-2">
              <p>The Muscle Heatmap provides a visual representation of which muscle groups you've been training.</p>
              <p>Each muscle shows the total number of sets performed during the selected period.</p>
              <p>Use this to identify imbalances in your training and ensure you're giving attention to all major muscle groups.</p>
            </div>
          </details>
        </div>
      </main>
