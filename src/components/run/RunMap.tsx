...
export function RunMap({ polyline, className = '', height = '400px' }: RunMapProps) {
  ...
  const startPoint: LatLngTuple =
    coordinates.length > 0 ? [coordinates[0][0], coordinates[0][1]] : [0, 0]
  ...
  const hasValidCoordinates =
    coordinates.length > 0 && !(startPoint[0] === 0 && startPoint[1] === 0)
  ...
  return (
    <div className={className} style={{ height }}>
      ...
      >
        ...
        {/* Start marker */}
        {defaultIcon && <Marker position={startPoint} icon={defaultIcon} />}
