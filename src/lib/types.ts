...
export const COMMON_EXERCISES: Exercise[] = [
  // Legs
  { name: 'Squats', muscleGroup: MuscleGroup.LEGS, description: 'Compound leg exercise targeting quads, hamstrings, and glutes' },
  ...
  { name: 'Deadlifts', muscleGroup: MuscleGroup.LEGS, description: 'Compound exercise targeting posterior chain' },
  ...
  // Chest
  { name: 'Bench Press', muscleGroup: MuscleGroup.CHEST, description: 'Compound pushing exercise targeting chest, shoulders, and triceps' },
  ...
  // Back
  { name: 'Pull-Ups', muscleGroup: MuscleGroup.BACK, description: 'Compound pulling exercise targeting lats and biceps' },
  ...
  // Shoulders
  { name: 'Overhead Press', muscleGroup: MuscleGroup.SHOULDERS, description: 'Compound pressing exercise for deltoids' },
  ...
  // Arms
  { name: 'Bicep Curls', muscleGroup: MuscleGroup.ARMS, description: 'Isolation exercise for biceps' },
...
export function findMuscleGroupForExercise(exerciseName: string): MuscleGroup {
  const exercise = COMMON_EXERCISES.find(
